...
namespace GodotMCP.Server.Transport;

/// 4-byte big-endian length prefix followed by UTF-8 JSON payload.
/// Payloads with embedded newlines are safe; no escaping needed.
